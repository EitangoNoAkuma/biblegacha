...
function BibleGacha() {
  ...
  const [savedVerses, setSavedVerses] = useState(loadSavedVerses)
  ...
  return (
    <div className="bible-gacha">
      <header className="gacha-header">
        <h1 className="gacha-title">Bible Gacha</h1>
        <p className="gacha-subtitle">King James Version (1611)</p>
      </header>
